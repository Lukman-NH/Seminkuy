      ...
      <div class="d-flex" id="wrapper" data-aos="fade-right">
        ...
        <div class="border-right" id="sidebar-wrapper">
          <div class="sidebar-heading text-center">
            <img src="{{ url ('/images/admin.png') }}" alt="" class="my-4" />
          </div>
          <div class="list-group list-group-flush">
            ...
            class="list-group-item list-group-item-action {{ (request()->is('admin/event-gallery*')) ? 'active' : '' }} "
              >Event Gallery</a
            >
            <a
            ...
            <a
              ...
              class="list-group-item list-group-item-action {{ (request()->is('admin/rating')) ? 'active' : '' }} "
              >Rating</a
            >
            <a
              href="{{ route('logout') }}"
